  ...
  return (
    <>
      <header className="text-gray-600 dark:text-gray-300 body-font">
        <div className="container mx-auto flex flex-wrap p-5 sm:justify-between flex-row items-center  justify-center ">
          ...
          <div className='w-10 h-6 flex flex-col gap-y-3 md:hidden bg-red-700 cursor-pointer'>
            {[1,2,3].map(item => {
              return <div className='bg-white w-6 h-4 block'></div>
            })}
          ...
          <div className="w-24 smooth dark-btn-bg h-10 rounded-full bg-blue-500 my-3 mx-3 relative px-2 cursor-pointer  md:flex items-center justify-between hidden dark:bg-gray-800/30" onClick={toggleDarkMode}>
